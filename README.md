...
장애를 어떻게 재현하고 복구 설계를 검증했는지는 [Web3 트러블슈팅 사례](docs/case-studies/README.md)에 정리했습니다. 원시 로그나 비밀값 대신 실패 시나리오, 실험 조건, 상태 전이, 테스트와 한계를 공개합니다.
...
Copyright © 2026 naesan-project. All rights reserved.

이 저장소는 포트폴리오 검토를 위해 공개되어 있으며 오픈소스 라이선스를 제공하지 않습니다. 별도의 서면 허가 없이 코드, 문서와 디자인 자산을 복제, 수정, 배포하거나 상업적으로 이용할 수 없습니다.
